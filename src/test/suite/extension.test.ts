...
suite('Extension Test Suite', () => {
	...
	test('launchConfigIsValid is true when test runner config holds a valid launch conifg', () => {
		const result = alTestRunner.launchConfigIsValid({launchConfigName: "someLaunchConfig", companyName: "", containerResultPath: "", securePassword: "", testSuiteName: "", userName: "", remoteContainerName: "", remotePort: 0, executionPreference: ""},
	...
	test('launchConfigIsValid is false when the test runner has a blank launch config', () => {
		const result = alTestRunner.launchConfigIsValid({launchConfigName: "", companyName: "", containerResultPath: "", securePassword: "", testSuiteName: "", userName: "", remoteContainerName: "", remotePort: 0, executionPreference: ""},
	...
	test('launchConfigIsValid is false when the test runner has a launch config not in launch.json', () => {
		const result = alTestRunner.launchConfigIsValid({launchConfigName: "does not exist", companyName: "", containerResultPath: "", securePassword: "", testSuiteName: "", userName: "", remoteContainerName: "", remotePort: 0, executionPreference: ""},
			{configurations: [{type: "al", request: "launch", name: "launchConfig"}]});
			assert.strictEqual(result, false);
	});
